...
{
    internal class ClosedXmlBenchmarkRunner : BenchmarkRunner<IXLWorksheet>
    {
        public ClosedXmlBenchmarkRunner(IAppConfig appConfig) : base(appConfig)
        {
        }
        ...
        {
            var workbook = new XLWorkbook(_largeFileName);
            if (savingResultingFile)
            {
